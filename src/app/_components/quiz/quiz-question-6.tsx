...
export default function Question6({ 
  ...
  choices = [
    {
      id: 1,
      label: "🛡️ Check for Security Risks",
      icon: "/quiz/Q6B.png",

    },
    {
      id: 2,
      label: "📦 Proceed with Download",
      icon: "/quiz/Q6A.png",
    ...
    <div className="flex flex-col items-center">
      ...
      <div className="relative flex items-center gap-6">
        ...
        <div className="text-right mb-50">
          <p className="text-[#5b4636] text-l font-bold">{choice1.label}</p>
        </div>
        ...
        <div className="text-left mt-50">
          <p className="text-[#5b4636] text-l font-bold">{choice2.label}</p>
        </div>
      </div>
    </div>
  );
